---
title: "Understanding LayoutLMv3"
description: "How LayoutLMv3 unifies text and image masking for document AI: the intuition behind MLM, MIM, and Word-Patch Alignment, with a worked invoice fine-tuning example."
date: 2023-02-24
author: "Zacharie Buisson"
categories: [Document AI, Deep Learning, NLP]
image: images/layoutlmv3.png
---
...
### LayoutLMv3: a theoretical description
...
![An example of MLM. Taken from [*Self-Supervised Contextual Data Augmentation for Natural Language Processing*](https://www.researchgate.net/publication/337187647_Self-Supervised_Contextual_Data_Augmentation_for_Natural_Language_Processing).](images/mlm_bert.png)
...
![An example of MIM using BEiT. Taken from [*BEiT: BERT Pre-Training of Image Transformers*](https://arxiv.org/pdf/2106.08254.pdf).](images/mim_beit.png)
...
LayoutLMv3 is a mix of these three techniques. The link between them is described in the image below.

![Summary of LayoutLMv3. Taken from [*LayoutLMv3: Pre-training for Document AI with Unified Text and Image Masking*](https://arxiv.org/pdf/2204.08387.pdf).](images/layoutlmv3.png)

### Strengths of LayoutLMv3
